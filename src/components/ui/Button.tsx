...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  scrollArrow:
    'absolute left-2 top-1/2 -translate-y-1/2 z-20 bg-white/10 backdrop-blur-md p-3 rounded-full shadow-xl hidden lg:flex items-center justify-center text-white opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:bg-white/20 hover:scale-110 active:scale-95 focus:outline-none',
  scrollArrowRight:
    'absolute right-2 top-1/2 -translate-y-1/2 z-20 bg-white/10 backdrop-blur-md p-3 rounded-full shadow-xl hidden lg:flex items-center justify-center text-white opacity-0 translate-x-4 group-hover:opacity-100 group-hover:-translate-x-0 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:bg-white/20 hover:scale-110 active:scale-95 focus:outline-none',
};
